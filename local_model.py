    ...
    def analyze_keywords(self, text: str) -> Dict[str, Any]:
        ...
        keyword_categories = {
            ...
            'violence_threats': [
                ...
                'shoot you', 'stab you', 'burn you', 'torture you'
            ],
            'bullying_harassment': [
            ...
            'body_shaming': [
                ...
                'you look like', 'no one will love you', 'youre ugly'
            ],
            'mental_health_shaming': [
                'crazy', 'insane', 'mental', 'psycho', 'retarded', 'stupid',
                'idiot', 'moron', 'dumb', 'brain dead', 'no brain'
            ],
            'genz_slang_harassment': [
                'touch grass', 'go outside', 'get a life', 'no friends',
                'incel', 'redpill', 'blackpill', 'mgtow', 'simp', 'white knight',
                'soy boy', 'beta', 'alpha', 'chad', 'virgin', 'loser',
                'cringe', 'cringey', 'embarrassing', 'pathetic', 'sad'
            ],
            'online_harassment': [
            ...
            'trolling_baiting': [
                ...
                'snowflake', 'sensitive', 'cant take a joke'
            ]
        }
        ...
        for category, keywords in keyword_categories.items():
            ...
            for keyword in keywords:
                if keyword in text_lower:
                    ...
                    if any(severe in keyword for severe in ['kill yourself', 'kys', 'unalive', 'hate', 'racist', 'threat', 'violence']):
        ...
        try:
            ...
            return {
                ...
                'detailed_analysis': {
                    ...
                    'risk_level': 'HIGH' if keyword_analysis['malicious_score'] >= 5 else 'MEDIUM' if keyword_analysis['malicious_score'] >= 3 else 'LOW',
