...
class CustomTopicAnalyzer:
    ...
    def generate_embeddings(self, texts: List[str], use_cache: bool = True, batch_size: int = 32) -> np.ndarray:
        """
...
def analyze_malicious_posts_topics(
    ...
    try:
        # Initialize analyzer
        analyzer = CustomTopicAnalyzer(n_topics=n_topics, min_topic_size=min_topic_size)
