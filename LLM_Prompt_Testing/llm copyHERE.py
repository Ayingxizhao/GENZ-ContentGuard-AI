...
def analyze_post_content(title, content):
    ...
    Evaluate the provided Reddit post for relevant information about it's maliciousness/harmfulness. 
    If the post seems to contain malicious language or content, respond with 'MALICIOUS'. Otherwise, respond with 'SAFE'. 
    If the post is malicious, classify it as either 'HATE-SPEECH', 'THREATS', 'BULLYING', or 'HARMFUL-PROMOTION' and append this classification to your response.""" 
